...
import { shallow, mount } from "enzyme"; // 'shallow' renderuje komponent ale bez jego dzieci a 'mount' renderuje komponent razem z dziećmi
...
// describe pozwala na zgrupowanie kilku testów
describe("rendering components", () => {
  ...
  it("renders button", () => {
    ...
    const label = wrapper.find("#balance-button").text(); // find pozwala na znalezienie elementu czyli taki jakby querySelector, .text() wybiera wartość textową
...
describe("passing props", () => {
  ...
  it("accepts user account props", () => {
    expect(accountWrapper.props().accounts).toEqual(userBalance); // trzeba wywołać funkcję .props() żeby dostać się do propów
  });

  it("contains saving Balance value", () => {
